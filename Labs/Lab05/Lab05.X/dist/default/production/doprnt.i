...
# 1 "D:/Program Files/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\\pic\\include\\__unsupported.h" 1 3
 ...
 *ap = __va_start();
 ...
 while((c = *f++)) {
  ...
  for(;;) {
   switch(*f) {
# 596 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\sources\\c90\\common\\doprnt.c"
   case '0':
    flag |= 0x04;
    f++;
    continue;
...
# 614 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\sources\\c90\\common\\doprnt.c"
...
# 1138 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\sources\\c90\\common\\doprnt.c"
    ...
    if(flag & 0x04) {
     ...
     if(flag & 0x03)
      ...
      ((*sp++ = ('-')));
# 1194 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\sources\\c90\\common\\doprnt.c"
     while(width > 0) {
      ((*sp++ = ('0')));
      width--;
     }
...
# 1407 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\sources\\c90\\common\\doprnt.c"
  if(width > c)
   width -= c;
  else
   width = 0;
  ...
  if(flag & 0x04) {
   ...
   if(flag & 0x03)
    ((*sp++ = ('-')));
# 1441 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\sources\\c90\\common\\doprnt.c"
   if(width)
    do
     ((*sp++ = ('0')));
    while(--width);
