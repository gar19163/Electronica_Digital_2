...
/**
 * main.c
 * Código ejemplo de uso del módulo UART
 */
//**************************************************************************************************************
// Librerias
//**************************************************************************************************************
...
int main(void)
{
    ...
    // Se inicializa la comunicaciÛn UART
    InitUART();
    ...
    while (1)
    {
        UARTCharPut(UART0_BASE, 85);
        UARTCharPut(UART0_BASE, 86);
        UARTCharPut(UART0_BASE, 71);
        UARTCharPut(UART0_BASE, 10);
        UARTCharPut(UART0_BASE, 13);
        SysCtlDelay(XTAL/3);
    }
